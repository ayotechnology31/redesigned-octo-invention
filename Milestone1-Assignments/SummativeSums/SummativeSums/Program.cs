...
namespace SummativeSums
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			int array1 = AddArray1();
			int array2 = AddArray2();
			int array3 = AddArray3();
			Console.WriteLine("#1 Array Sum: " + array1);
			Console.WriteLine("#2 Array Sum: " + array2);
			Console.WriteLine("#3 Array Sum: " + array3);
